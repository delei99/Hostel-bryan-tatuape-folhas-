                ...
                <tbody>
                  {currentRoom.guests.map((guest, index) => {
                    ...
                    >
                      <td className="px-6 py-2">
                        {index < 31 ? (
                          ...
                          <Input
                            ...
                            placeholder="Dia"
                            className="border-gray-300 text-base h-8 font-bold w-full"
                      ...
                      <td className="px-6 py-2 min-w-50">
                        <Input
                          type="text"
                        ...
                        {(() => {
                          ...
                          return (
                            <Input
                              ...
                              onBlur={() => setFocusedFieldId(null)}
                              placeholder="Valor"
                              className={`border-gray-300 text-base h-8 text-blue-600 font-bold w-full ${
                                false ? "" : ""
                              }`}
                              disabled={isLineBlocked}
                        ...
                        {(() => {
                          ...
                          return (
                            <Input
                              ...
                              onBlur={() => setFocusedFieldId(null)}
                              placeholder="Valor"
                              className={`border-gray-300 text-base h-8 text-blue-600 font-bold w-30 ${
                                false ? "" : ""
                              }`}
                              disabled={isLineBlocked}
                        ...
                        {(() => {
                          ...
                          return (
                            <Input
                              ...
                              onBlur={() => setFocusedFieldId(null)}
                              placeholder="Valor"
                              className={`border-gray-300 text-base h-8 text-red-600 font-bold w-full ${
                                false ? "" : ""
                              }`}
                              disabled={isLineBlocked}
                        ...
                        {(() => {
                          ...
                          return (
                            <Input
                              ...
                              readOnly
                              placeholder="-"
                              className={`border-gray-300 text-base h-8 text-blue-600 font-bold bg-gray-50 w-full`}
