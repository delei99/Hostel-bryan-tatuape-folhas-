                      ...
                      <td className="px-3 py-3">
                        {index < 31 ? (
                          ...
                          <Input
                            ...
                            placeholder="Dia"
                            className="border-gray-300 text-sm h-16 font-bold w-full"
                        ...
                        {(() => {
                          ...
                          return (
                            <Input
                              ...
                              onBlur={() => setFocusedFieldId(null)}
                              placeholder="Valor"
                              className={`border-gray-300 text-sm h-16 text-blue-600 font-bold w-full ${
                        ...
                        {(() => {
                          ...
                          return (
                            <Input
                              ...
                              onBlur={() => setFocusedFieldId(null)}
                              placeholder="Valor"
                              className={`border-gray-300 text-sm h-16 text-red-600 font-bold w-full ${
                        ...
                        {(() => {
                          ...
                          return (
                            <Input
                              ...
                              readOnly
                              placeholder="-"
                              className={`border-gray-300 text-sm h-16 text-blue-600 font-bold bg-gray-50 w-full`}
